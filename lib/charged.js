 ...
 * is null.
 */
Chargify.prototype.getSubscriptions =

Chargify.prototype.listSubscriptions = function (options, callback) {
	var scope = this;
...
Chargify.prototype.listSubscriptionsPage = function (options, callback) {
	if (!callback) {
		callback = options;
		options = null;
	}
...
Chargify.prototype.getRelevantCustomerDetails = function (subscriberDetails, customerDataFromRemoteProvider) {
